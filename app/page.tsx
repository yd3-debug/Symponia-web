...
const FAQS = [
  ...
  { q: 'How do tokens work?', a: 'Each conversation exchange uses 1 token — roughly 2 messages back and forth. New users start with 10 free readings. Top up with 50 tokens for £4.99 or 150 tokens for £9.99 (never expire), or subscribe monthly for £12.99 and receive 350 fresh tokens every month. All purchases are made within the app.' },
